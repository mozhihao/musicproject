<%@ page language="java" import="java.util.*"  import="com.mzh.po.News"   pageEncoding="utf-8" %>
<!DOCTYPE html>
<html lang="">
<head>
	<meta charset="gbk">
...
<section class="content">
	<section class="widget" style="min-height:300px">
		...
		<form action="upNews">
		<input type="hidden" name='News_id' readonly="readonly" value="<%=news.getNews_id() %>">
		<div class="content">
			<div class="field-wrap">
				<input type="text"  name='news_title' value='<%=news.getNews_title() %>'/>
			</div>
			<div class="field-wrap wysiwyg-wrap">
				<textarea class="post" rows="5" name='news_content' ><%=news.getNews_content() %></textarea>
			</div>
