...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  		<jsp:include page="head.jsp"></jsp:include>
			 ...
			 <h3>以下为音乐榜下载Top10</h3>
		<%
			List<Ablum> l=(List)request.getAttribute("ranking");
			for(Ablum a:l){%>
			<div class="album" >
			<!-- 链接到介绍播放页，还没写 -->
            <a class="left" href="SongInfo.php?albumId=<%=a.getAlbumId()%>" target="_blank">
            ...
            <dl id="yz">
                ...
                <dt>下载量：<span><%=a.getDownloadNum() %></span></dt>
                <p>
                <dt><a href="" target="_blank">立即购买</a>       <a href="add_cart_succeed?albumId=<%=a.getAlbumId() %>">加入购物车</a></dt>
            </dl>
            </div>	
           <%}%>
 </div>		
